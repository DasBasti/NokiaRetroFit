...
$EndSheet
$Sheet
S 7700 4050 1150 1950
U 580EAE94
F0 "WiFi/BT Controller" 60
F1 "WIFI.sch" 60
F2 "~LINK_UP" O L 7700 4900 60 
F3 "~INT" O L 7700 5000 60 
F4 "~RESET" I L 7700 5100 60 
F5 "GPIO0" I L 7700 5200 60 
F6 "ESP_UART[0..3]" B L 7700 4150 60 
F7 "CH_PD" I L 7700 5600 60 
F8 "GPIO12" B L 7700 5300 60 
F9 "GPIO13" B L 7700 5400 60 
$EndSheet
$Comp
L CONN_01X02 P109
U 1 1 580EBF81
...
$Sheet
S 9700 6000 1150 400 
U 5805F4BA
F0 "Buttons and LEDs" 60
F1 "INPUT.sch" 60
F2 "~ON" O L 9700 6100 60 
F3 "KEY[0..7]" B L 9700 6200 60 
F4 "LED[0..5]" I L 9700 6300 60 
$EndSheet
Wire Wire Line
	5350 7300 5600 7300
Wire Bus Line
...
F25 "UART[0..3]" B R 5350 2300 60 
F26 "HST_DL[0..1]" B R 5350 2500 60 
F27 "CH_PD" O R 5350 5850 60 
F28 "GPIO12" B R 5350 5550 60 
F29 "GPIO13" B R 5350 5650 60 
F30 "DISPLAY_DATA[0..16]" O L 3650 6200 60 
$EndSheet
Wire Wire Line
	9050 1800 8300 1800
Wire Wire Line
